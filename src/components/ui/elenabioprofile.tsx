    ...
    <div>
      <div className="bg-[#191970] pb-6">
        ...
        <div className="flex flex-col sm:flex sm:flex-row">
          ...
          <section className="photo">
            <figure>
              <Image id="Elena_profile_photo" className="mb-[10%] mt-[20%] sm:w-[75%] md:w-[70%] md:mr-[35%] md:ml-[15%] border-slate-500 border-[5px] border-solid rounded-xl transform transition hover:scale-150" src={elenabiophoto5} alt="" />
              <figcaption>
                <strong></strong>
              </figcaption>
            </figure>
