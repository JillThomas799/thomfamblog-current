...
export default function November2025() {
  ...
  return (   
 <div className=" bg-[#383f17] border-solid border-2 border-[#22311d] mb-28"> {/*November block background*/}
    <div>
      ...
      <div className="flex flex-col max-w-full leading-1.5 sm:p-2 md:p-2 lg:p-2 m-4 border-gray-800 border-solid border-2 bg-[#b55b4b] ">
        ...
        <div className="font-bold text-left border-solid text-black font-normal border-black border-2 mr-1 ml-1 mb-4 mt-4 px-4 py-4 bg-[#61603c]">
      ...
      <div className="flex flex-col max-w-full leading-1.5 sm:p-2 md:p-2 lg:p-2 m-4 border-gray-800 border-solid border-2 bg-[#b55b4b]">
         <div className="text-md md:text-lg max-w-full font-bold text-[#D99E49] text-center dark:text-[#D99E49] justify-center items-center">
        <div className="font-bold py-2 px-12 text-[#22311d] text-center dark:text-[#22311d]"> 1st November 2025</div> {/*End of news date block*/} 
        <div className="font-bold border-solid border-black border-2 mr-1 ml-1 mb-4 px-4 py-4 bg-[#61603c]">Sizergh Castle in the electric car</div> {/*End of news header block*/}
