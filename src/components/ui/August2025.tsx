...
<div>
   ...
   <div className="flex flex-col w-1/2 max-w-[320px] leading-5 p-8 m-8 border-solid border-gray-700 bg-[#FBE9D0] text-[#244845] rounded-e-xl rounded-es-xl dark:bg-[#FBE9D0">
      <div className="flex items-center space-x-2 rtl:space-x-reverse">
         <span className="font-bold text-2xl text-[#244845] dark:text-[#244845]">What's new this month?</span>
      </div>
    </div>
</div>
...
<div className="flex items-start gap-2.5">
   <div className="flex flex-col w-1/2 max-w-[320px] leading-5 p-8 m-8 border-solid border-gray-700 bg-[#FBE9D0] text-[#244845] rounded-e-xl rounded-es-xl dark:bg-[#FBE9D0">
      <div className="flex items-center space-x-2 rtl:space-x-reverse">
         <span className="font-bold text-2xl text-[#244845] dark:text-[#244845]">Most importantly, what has the Thomas Family been up to this month?</span>
      </div>
    </div>
</div>
 <div className="flex flex-row justify-end">
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="font-normal"> There is plenty in the diary
         ...
         <ul className="list-disc list-inside pl-4 text-align-left">
          ...
          <li className="text-[#874F41]">Short break in Southsea near Portsmouth</li>
          <li className="text-[#874F41]">Harry prepares for his new job-start in September</li>
