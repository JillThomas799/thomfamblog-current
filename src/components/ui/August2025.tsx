...
<div className="flex items-start  mt-[120%] md:mt-[50vh]">
   <div className="flex flex-col max-w-full leading-5 p-4 m-8 border-solid  border-gray-800 border-[2px] bg-[#c6b363] text-[#5A7833]] rounded-e-xl rounded-es-xl dark:bg-[#c6b363]">
...
<div className="flex flex-row justify-end">
   <div className="flex flex-col text-sm md:text-md lg:text-lg xl:text-xl max-w-full leading-1.5 p-4 m-8  border-gray-800 border-solid border-[2px] bg-[#c6b363] rounded-tl-3xl rounded-bl-3xl rounded-br-3xl">
      <div className="flex flex-col justify-center">
         <div className="text-lg max-w-full font-bold text-[#5] text-center dark:text-[#244845] justify-center items-center">
         A NEW SECURE INTERACTIVE WEBSITE 
        <div className="font-bold"> which has the following new features
         </div>
         <ul className="list-disc list-inside pl-4 space-y-2 text-align-left font-semibold text-[#3C4142]">
          <li>Secure log-in.</li>
          <li>Facility to post comments</li>
          <li>Facility to upload your own photos</li>
         </ul>
         <br />
         <div className="font-semibold">So do feel welcome to add comments, post a suitable photo of your own and be reassured that you have privacy and additional security throughout!
         <br />
         <br />
         </div>
      </div>
...
<div className="flex items-start gap-2.5">
   <div className="flex flex-col max-w-full leading-1.5 p-4 m-8  border-gray-800 border-solid border-[2px] bg-[#c6b363] text-[#244845] rounded-e-xl rounded-es-xl dark:bg-[#c6b363]">
      <div className="flex items-center space-x-2 rtl:space-x-reverse">
 ...
 <div className="flex flex-col justify-end">
   <div className="flex flex-col max-w-full  leading-1.5 p-4 m-8 border-gray-800 border-solid border-[2px] bg-[#c6b363] rounded-tl-3xl rounded-bl-3xl rounded-br-3xl">
      <div className="flex flex-col justify-center">
        ...
        <div className="font-bold"> The new app consists of a stack of the following new features:
         ...
         <ul className="list-disc list-inside pl-4 space-y-2 font-semibold text-align-left text-[#3C4142]">
          <li>Typescript</li>
         ...
         <div className="font-semibold text-md">So there has been lots to learn and still much more studying to be done... </div>
          ...
          <div className="flex items-start gap-2.5">
   <div className="flex flex-col font-normal max-w-full leading-5 p-4 m-8 border-solid  border-gray-800 border-[2px] bg-[#c6b363] text-[#244845] rounded-e-xl rounded-es-xl dark:bg-[#c6b363]">
      <div className="flex items-center space-x-2 rtl:space-x-reverse">
      ...
      <div className="flex flex-row justify-end">
   <div className="flex flex-col max-w-full leading-1.5 p-4 m-8 border-solid  border-gray-800 border-2 bg-[#c6b363] rounded-tl-3xl rounded-bl-3xl rounded-br-3xl text-xs">
      <div className="flex flex-col justify-center">
        ...
        <div className="font-bold w-full"> There is plenty in the diary:
         ...
         <ul className="list-disc list-inside space-y-2 pl-4 font-semibold text-align-left text-md text-[#3C4142]">
          ...
          <li>Harry preparing for his new job-start in September to become a Digital and Technology professional.</li>        
          <li>Elena's partner meets the family for the first time.</li>          
         </ul>
      </div>
      </div>
    </div>
 ...
 <div className="mb-20">
      <div className="flex flex-col max-w-full leading-1.5  sm:p-2 md:p-2 lg:p-2 m-4 bg-[#c6b363]]">
        ...
        <div className="font-bold py-2 px-12 mt-4"> 16th August 2025</div>
        <div className="font-bold border-solid border-[#5A7833] border-4 rounded-md mt-4 ml-6 mr-6 mb-4 py-4 bg-[#A5AE92]"> Day trip to London to visit Westminster Abbey and Buckingham Palace. </div>
        <div className="pr-3 pl-3 md:pr-10 md:pl-10 font-semibold text-center">Today we had a prompt 6am start to catch the train to London for the day. We had two destinations in mind; Westminster Abbey and Buckingham Palace. We thought we had visited neither before but it subsequently transpired that we had actually visited Buckingham Palace in 1998.
          <br />
          <br />
          Jill had spent the previous week trying to cram the whole of the history of Westminster Abbey with the help of an extremely readable and well-researched book; <Link href="https://www.amazon.co.uk/Westminster-Abbey-History-David-Cannadine/dp/1913107477?crid=32WQ8FZCSYRVX&dib=eyJ2IjoiMSJ9.VWfixm0jckHCq2KLAA7_OeQT7wHjFG0EhPoeHr3H7YpFPgiaOxiyd4lXHGSF5kxo54aVXKc7UHF33sc69m9k1gXC1p6BRrBo_yVPRA2q03fyL2sq5_oPqkI2SXLnHIody5YXQ11FMfe68hbBfCTr0lTrEUVxF0_2A8zCrytRxM_L5FAee8GkYELZfn8Qw6UhrNHC_XeEaIFrT2KwdTnd_iXI9sEFqlRWZOy7xGKrs-8.HL2MQKqJBXroVCQ3tXYK28wjNgazkWzA0IXrAYDgW9s&dib_tag=se&keywords=westminster+abbey&qid=1755707556&sprefix=westminster+abbey%2Caps%2C126&sr=8-1" target="_blank" className="underline decoration-blue-700 text-[#9B5F38] font-bold" >"Westminster: A Church in History"</Link>  by David Canadine. This is a far more readable book than might be imagined and made a real difference to our getting the most out of our visit to the abbey on this occasion.
          <br />
          <br />
          After lunch we headed over to Buckingham Palace. We visited the State Rooms on this occasion. We were not allowed to take photos at all during our visit, so sorry no photos available. The staff at the Palace were fantastic and made everything run (more or less) smoothly. It is well worth a visit whatever your views are on the monarchy.
           </div>
          ...
          <div className="flex flex-col border-solid border-4 border-[#5A7833] bg-[#A5AE92] pb-2 pt-2 mr-[12%] ml-[12%] mt-8 mb-12 justify-center text-center">
            <div className="mt-1 mb-1 sm:m-2 text-md font-bold block text-[#22311d] bg-[#A5AE92]">
              {" "}
                <div className="m-1 p-1 font-bold  border-[#5A7833] border-solid border-4 bg-[#c6b363]">Click on the image below <br /> to open the album <br /> of our trip to
                London.</div>
                <br />
              <br />
              <Link
       ...
       <div className="flex flex-col max-w-full leading-1.5  sm:p-2 md:p-2 lg:p-2 m-4 border-gray-800 border-solid border-2  bg-[#c6b363]">
        ...
        <div className="font-bold border-solid border-[#5A7833] border-4 rounded-md mt-4 ml-6 mr-6 mb-4 py-4 bg-[#A5AE92]">  Visit to the Dinosaur rEvolution exhibition at the Tullie Museum, Carlisle</div>
        <div className="pr-3 pl-3 md:pr-10 md:pl-10 font-semibold text-center">This exhibition by Godwana studios arrived at the Tullie at the end of June and is due to run until mid-September. We had heard good reports of it and so today we braved the school holidays to go and take a closer look ourselves before we lost out chance!
          <br />
          <br />
          ...
          <br />
          <br />
          The artist Luis Vrey has written in a <Link href="https://luisvrey.blog/2024/02/16/the-deed-is-done-dinosaur-revolution-is-a-resounding-success-at-the-horniman-museum/" target="_blank" className="underline decoration-blue-700 text-[#9B5F38] font-bold" > blog </Link> relating to the exhibition's showing at the Horniman Museum in London (one of the other sites in the UK where it was showing), and which shows some of the fossil reprints, all about how the exhibition almost did not make it over on time to Europe from Australia and New Zealand. In case you are wondering who Luis Vrey is, Luis Vrey is described by his Wikipedia entry as being best known for his innovative work in the field of dinosaur paleoart. In conjunction with Robert T. Bakker, he promoted awareness of the developing evidence for feathered dinosaurs. Rey is apparently an active member of the Society of Vertebrate Paleontology and of the Dinosaur Society (UK).
          <br />
          <br />
          Additionally, in this <Link href="https://gondwanastudios.com/dinosaur-revolution/" target="_blank" className="underline decoration-blue-700 text-[#9B5F38] font-bold" > article </Link>, Godwana studios talks all about the dinosaur revolution exhibition itself.
          <br />
          <br />
...
<div className="flex flex-col max-w-full leading-1.5 sm:p-2 md:p-2 lg:p-2 m-4 border-gray-800 border-solid border-2  bg-[#c6b363]">
        ...
        <div className="font-bold border-solid border-[#5A7833] border-4 rounded-md mt-4 ml-6 mr-6 mb-4 py-4 bg-[#A5AE92]">  Portsmouth Historic Dockyard day 1: Guided Tour of the <br />Mary Rose and all aboard HMS Victory  with Lord Horatio Nelson <br />to head out to the Battle of Trafalgar against the <br />French and Spanish.</div>
        <div className="pr-3 pl-3 md:pr-10 md:pl-10 font-semibold text-center"> Well today, we were well-settled into our cottage accommodation in Southsea for the duration of our stay and it was time to head off to Portsmouth Historic Dockyard for the first of our 3 visits over the coming days. <Link href="https://historicdockyard.co.uk/" target="_blank" className="  underline decoration-blue-700 text-[#9B5F38] font-bold">Portsmouth Historic Dockyard</Link> is an area of HM Naval Base Portsmouth which is open to the public and contains several historic buildings and ships. The Royal Navy has had its home in Portsmouth Harbour since 1194. We opted to purchase Ultimate Explorer tickets as these permitted us unlimited access to all the attractions for 12 months.
          <br />
          <br />
          ...
          <br />
          <br />
          This <Link href="https://open.spotify.com/episode/0duZBdwzqWbzvh9me0Y4EA?si=luOZrDYQRzWH-U101WhWug" target="_blank" className="underline decoration-blue-700 text-[#9B5F38]  font-bold">Not Just the Tudors</Link> podcast talks about the sinking of the Mary Rose. There is far too much that can be related about the Mary Rose, its discovery and subsequent salvage and restoration to discuss here but it is well worth the visit and finding out more.
          
          
          <div className="flex flex-col border-solid border-4 border-[#5A7833] bg-[#A5AE92] pb-2 pt-2 mr-[2%] ml-[2%] mt-8 mb-12 justify-center text-center">
            <div className="mt-1 mb-1 sm:m-2 text-md font-bold block text-[#22311d] bg-[#A5AE92]">
              {" "}
                <div className="m-1 p-1 font-bold  border-[#5A7833] border-solid border-4 bg-[#c6b363]">Click on the image below to open the album of our Day 1 visit to Portsmouth Historic: - Mary Rose Exhibition and HMS Victory.</div>
                <br />
              <br />
              <Link
       ...
       <br />
       <br />
       Finally, to see us out of this blog entry, HMS Victory will take us out with <Link href="https://youtu.be/f_FpYLnNhVw?si=Pua9zvxv9O4d_HZC" target="_blank" className="underline decoration-blue-700 text-[#9B5F38] font-bold">HMS Victory in action, firing rolling broadside</Link>.
      <br />
      <br />
       ...
       <div className="flex flex-col max-w-full leading-1.5 sm:p-2 md:p-2 lg:p-2 m-4 border-gray-800 border-solid border-2  bg-[#c6b363]">    
        ...
        <div className="font-bold border-solid border-[#5A7833] border-4 rounded-md mt-4 ml-6 mr-6 mb-4 py-4 bg-[#A5AE92]">  Visit to Stonehenge, Wiltshire</div>
         <div className="pr-4 pl-4 md:pr-10 md:pl-10 font-semibold text-left">
         ...
         <div className="flex flex-col border-solid border-4 border-[#5A7833] bg-[#A5AE92] pb-2 pt-2 mr-[12%] ml-[12%] mt-8 mb-12 justify-center text-center">
            <div className="mt-1 mb-1 sm:m-2 text-md font-bold block text-[#22311d] bg-[#A5AE92]">
              {" "}
                <div className="m-1 p-1 font-bold  border-[#5A7833] border-solid border-4 bg-[#c6b363]">Click on the image below to join us on our visit to Stonehenge and Japanese dinner at Sakura.</div>
                <br />
              <br />
              <Link
