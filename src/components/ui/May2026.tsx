  ...
  return (
    <div className="">
      <div className="bg-RavenglassEskdaleRailway bg-cover border-solid border-4 border-gray-600 md:p-4 mb-8 h-[50vh] text-[#D99E49] text-center font-normal text-l p-3">
        <div className="bg-gray-800 mr-[7%] ml-[7%] md:mr-[40%] md:ml-[40%] p-1 border-[#bdbeba] border-2 text-[white] font-semibold">May 2026</div>
        <br />
        <br />
         ...
         < div className="mb-20"> 
                < div className="flex flex-col w-auto leading-1.5 pt-4 mt-4 md:p-4 lg:p-4  border-[#bbe89e] border-solid border-2 md:border-2 bg-[#F38e7e]">
                   ...
                   <div className="font-semibold md:font-semibold p-2 m-2 text-white text-center  border-[#bbe89e] border-2 bg-[#93c572]">2nd May 2026, Saturday.</div> {/*End of news date block*/}
                        <div className="font-semibold md:font-semibold p-2 m-2 text-white text-center text-md border-[#bbe89e] border-2  bg-[#93c572]">'A Dog's Life' Exhibition at the Rheged Centre, Penrith and 'The Sheep Detectives' film at Rheged Cinema.</div>
                  <div className="font-normal md:font-semibold text-center text-white border-solid border-[#bbe89e] border-2 mr-1 ml-1 mt-2 px-4 py-2 mb-10 bg-[#93c572]">
                    ...
                    <br />
                          <br />
                    <div className="p-2 font-semibold md:font-semibold text-center text-sm md:text-md text-white border-[#bbe89e] border-solid border-2 bg-[#F38e7e] ">Click on the image below to open the album of our visit to 'A Dog's Life Exhibition' at the Rheged centre, Cumbria.
                          <br />
                          <br />
