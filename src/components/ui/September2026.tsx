...
export default function September2026() {
 ...
 <div> 
      ...
      <div className="flex flex-col max-w-full leading-1.5 sm:p-2 md:p-2 lg:p-2 m-4 border-[#436A6b] border-solid border-4 bg-[#afa488]">
        ...
        <div className="font-bold border-solid border-[#436A6b] border-4 mr-1 ml-1 mb-4 mt-4 px-2 py-2 text-[#E7E1F0]  bg-[#8d6fb0]">1st - 30th September 2026.</div> 
        ...
        <div className="font-bold border-solid border-[#436A6b] border-4 mr-1 ml-1 mb-4 mt-4 px-2 py-2 text-[#E7E1F0]  bg-[#8d6fb0]">1st September 2026.</div> 
        <div className="font-bold border-solid border-[#436A6b] border-4 mr-1 ml-1 mb-4 px-2 py-2 text-[#E7E1F0] bg-[#8d6fb0]">Whistle-stop tour of Northumberland and visit to the Holy Island of Lindisfarne.</div> 
           ...
           <div className="pr-1 pl-1 pb-2 md:pr-1 md:pl-1 font-semibold text-left text-white dark:text-white">
            <div className="text-center">Today was the big-day, the highlight of <em>'Operation Holy Island'</em>, it was time time to head over to the Holy Island of Lindisfarne. Causeway safe tide times for crossing for the day commenced at 9.40 am and lasted until about 15.35 so it meant a very early start!! 
            <br/>
            <br/>
            The best weather was set to be in the morning so it was decided to drive out via the B6318 as far as Chollerford, before turning North East across country via Colwell, Little Bavington, Rothley, Netherwitton and Long Horsley to join the A1 south of Alnwick, before heading the further 29 miles to the causeway.
            <br/>
            <br/>
            The B6318, known locally as the Military Road, is a historic 61-mile route in northern England that runs from Heddon-on-the-Wall in the east to Greenhead in the west The road closely follows the path of Hadrian's Wall, often running right alongside or directly over the top of Roman foundations. Though often mistaken for a Roman road due to its long, straight stretches, it was built between 1751 and 1757 to move military equipment. This followed transport failures by Hanoverian forces under Field Marshal George Wade during the 1745 Jacobite Rising. The road features long straight sections combined with sharp dips and blind summits that completely hide oncoming traffic, but we know it well and at the time we were going (between 7.30 and 8am), it was likely to be relatively quiet.
            <br/>
            <br/>
            Before we went though, it was time to brush up on some important religious history.....
            <br/>
            <br/>
            
            <div className="bg-[#8EA6A6]">
               <div className="bg-[rgb(67,106,107)] text-white text-center font-semibold p-1 md:p-6 border-[#f5f5f5] border-solid border-2">HISTORY OF THE HOLY ISLAND OF LINDISFARNE</div>
           ...
           On acceeding to become King Oswald of Northumbria in AD 634, he focused Northumbrian power in Bernicia, around the royal palaces at Yeavering, Mælmin (Milfield) and Bamburgh. 
            ...
            <br/>           
            It was a long drive but we got to see lots and when we finally arrived on Holy Island, parking was straightforward, as on this occasion we could use the free, disabled parking on Green Lane at the Chare Ends car park. Once parked, it was time to decamp to Chare Ends café for tea and coffees and to meet the very tame sparrows and starlings there. 
            <br />
            <br />            
            Refreshed, we made our way to Lindisfarne Museum and the ruins of Lindisfarne Priory to have a look around.
