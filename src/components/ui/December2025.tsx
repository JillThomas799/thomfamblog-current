...
export default function December2025() {
 ...
 <div className=" bg-black border-solid border-2 border-black mb-28"> {/*December block background*/}
    <div>
       <div className="text-white text-center font-semibold text-2xl p-3 bg-[#41231c] border-solid border-2 border-[#b55b4b] m-2 animate-pulse">December 2025
        </div> 
        <div className="block relative mt-[70%] mb-[135%] md:mt-[50%] md:scale-60 md:mb-[100%] lg:scale-80 text-center 
